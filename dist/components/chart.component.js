...
var deep_assign_service_1 = require("../services/deep-assign.service");
var ChartComponent = (function () {
    function ChartComponent(element, highchartsService, zone, chartService) {
    ...
    ChartComponent.prototype.init = function () {
        ...
        if (this.userOpts && this.baseOpts) {
            this.zone.runOutsideAngular(function () {
                _this.chart = _this.chartService.init(_this.highchartsService, _this.userOpts, _this.baseOpts, _this.type);
    ...
    ChartComponent = __decorate([
        core_1.Component({
            ...
            providers: [highcharts_service_1.HighchartsService, chart_service_1.ChartService, deep_assign_service_1.DeepAssignService],
        }),
        __metadata("design:paramtypes", [core_1.ElementRef, highcharts_service_1.HighchartsService, core_1.NgZone, chart_service_1.ChartService])
    ], ChartComponent);
